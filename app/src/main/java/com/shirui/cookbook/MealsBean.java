...
public class MealsBean implements Serializable {        //JavaBean类，因为获取到的Json数据为复杂数据，其为数组与对象的结合，该类中变量一一对应所需Json数据中的Json数组中的Json对象，实现Serializable接口序列化后可进行IO操作便于传输
